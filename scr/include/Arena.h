...
class ArenaAllocator
{
    public:
        ...
        explicit inline ArenaAllocator(const size_t max_num_bytes)
        ...
        inline ArenaAllocator(ArenaAllocator&& other) noexcept
        ...
        inline ArenaAllocator& operator=(ArenaAllocator&& other) noexcept
        {
